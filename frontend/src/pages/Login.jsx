...
export default function Login() {
  const [showSplash, setShowSplash] = useState(() => {
    return !sessionStorage.getItem('etherx_splash_shown');
  });

  const handleSplashComplete = () => {
    sessionStorage.setItem('etherx_splash_shown', 'true');
    setShowSplash(false);
  };
  ...
  useEffect(() => {
    ...
    if (params.get('error') === 'apple_config_missing' || params.get('error') === 'apple_auth_failed') {
      setError('Apple Sign-In is coming soon! Please sign in using your Email & Password.');
              ...
              <p className="auth-form-sub">Welcome back.</p>
               ...
               <div className="auth-social-group">
                ...
                <button type="button" className="auth-social-btn" onClick={() => {
                  ...
                  if (isPrivateIp) {
                    setError('Google OAuth redirects require a registered web domain or localhost. For local network testing, please sign in with Email & Password.');
                    return;
                  }
